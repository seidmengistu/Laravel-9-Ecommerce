                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route('register')}}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required name="name" placeholder="Name" :value="old('name')" autocomplete="name">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required name="email" placeholder="Email" :value="old('email')" autocomplete="">
                                            </div>
                                            <div class="form-group">
