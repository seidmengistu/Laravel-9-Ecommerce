                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a  class="{{ $pageSize==12 ? 'active':''}}" href="#" wire:click.prevent="setPage(12)">12</a></li>
                                            <li><a  class="{{ $pageSize==15 ? 'active':''}}" href="#" wire:click.prevent="setPage(15)">15</a></li>
                                            <li><a  class="{{ $pageSize==25 ? 'active':''}}" href="#" wire:click.prevent="setPage(25)">25</a></li>
                                            <li><a  class="{{ $pageSize==32 ? 'active':''}}" href="#" wire:click.prevent="setPage(32)">32</a></li>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{asset('assets/imgs/shop/product-')}}{{$new_product->id}}-2.jpg" alt="{{$new_product->name}}">
                                </div>
